...
const AdminUsuariosPage: React.FC = () => {
    return (
        <div className="space-y-10">
            <AdminHeader
                title="Usuários"
                description="Gestão de acesso e colaboração em equipe."
            />
            ...
            <div className="admin-card p-10 max-w-2xl">
                ...
                <ul className="space-y-4 mb-10">
                    {[
                        'Gestão de times com múltiplos níveis de acesso',
                        'Logs detalhados de login e segurança de conta',
                        'Criação de perfis personalizados para colaboradores'
                    ].map((item, i) => (
                ...
                <p className="text-sm font-bold text-brandDark/30 italic">
                    Segurança e eficiência para o crescimento do seu time.
                </p>
            </div>
        </div>
    );
