...
const AdminAssinaturasPage: React.FC = () => {
    return (
        <div className="space-y-10">
            <AdminHeader
                title="Assinaturas"
                description="Monitoramento e gestão dos ciclos de vida dos assinantes."
            />
            ...
            <div className="admin-card p-10 max-w-2xl">
                ...
                <ul className="space-y-4 mb-10">
                    {[
                        'Controle total do ciclo de faturamento e status',
                        'Gestão proativa de churn e réguas de retenção',
                        'Automação de renovações, upgrades e downgrades'
                    ].map((item, i) => (
                ...
                <p className="text-sm font-bold text-brandDark/30 italic">
                    Visibilidade completa do seu LTV e saúde da base.
                </p>
            </div>
        </div>
    );
