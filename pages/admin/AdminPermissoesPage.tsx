...
const AdminPermissoesPage: React.FC = () => {
    return (
        <div className="space-y-10">
            <AdminHeader
                title="Permissões"
                description="Configuração granular de privilégios e grupos de acesso."
            />
            ...
            <div className="admin-card p-10 max-w-2xl">
                ...
                <ul className="space-y-4 mb-10">
                    {[
                        'Controle RBAC (Role-Based Access Control) total',
                        'Personalização de grupos de acesso por departamento',
                        'Auditoria de alterações em níveis de permissão'
                    ].map((item, i) => (
                ...
                <p className="text-sm font-bold text-brandDark/30 italic">
                    Governança e controle total sobre quem acessa o quê.
                </p>
            </div>
        </div>
    );
